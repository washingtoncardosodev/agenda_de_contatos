...
class _HomePageState extends State<HomePage> {
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image:DecorationImage(
                    image: contacts[index].img != null ? FileImage(File(contacts[index].img)) : AssetImage("assets/images/default.png"),
                    fit: BoxFit.cover
                  )
                )
              ),
  ...
  void _orderLis(OrderOptions result) {
    switch(result) {
